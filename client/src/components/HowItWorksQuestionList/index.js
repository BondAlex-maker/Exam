...
import styles from "./HowItWorksQuestionList.module.sass";
...
const QuestionList = () => {
    return (
        <div className={styles.container}>
            <div className={classNames(styles.row, styles.howItWorkQuestion)}>
                ...
                <ul>
                    <li>
                        ...
                        <p>You always have an option of hiring a consultant or coming up with the name yourself.
                            ...
                            choice: you get to see ideas from dozens (in some cases, hundreds) of contestants before
                            you select a winner. Typically, you would spend far less money with Squadhelp (our
                            contests start at $199) than hiring an agency. Also, you will receive immediate results
                            - most contests begin receiving submissions within minutes of starting.</p>
                    </li>
                    <li className={styles.blackBg}>
                        <h4>How is Squadhelp Different?</h4>
                        <p>Since 2011, we have been committed to disrupting the traditional agency model. Our
                            platform offers much more than a typical crowdsourcing experience. From Machine Learning
                            to Audience Testing to Comprehensive Trademark Validation, you receive best-in-class
                            support for your branding projects.</p>
                        <p><strong>Breadth:</strong> Our Contest-Based Crowdsourcing approach allows you to receive
                            an unmatched breadth of name ideas from dozens of unique, creative minds while working
                            with the world's largest branding community.</p>
                        <p><strong>Quality and Collaboration:</strong> Using an advanced Quality Scoring Algorithm,
                            ...
                            communication throughout your contest.</p>
                        <p><strong>We don’t stop at ideation: </strong> Choose your name with confidence through our
                            high-end validation services. Poll your target demographics to get unbiased feedback on
                    ...
                    <li>
                        ...
                        <p>Yes! We believe that validating and securing your name is a critical part of your
                            ...
                            prices for Trademark filing for our customers.</p>
                    </li>
                    <li className={styles.blackBg}>
                        <h4>I’ve never used Squadhelp before. What should I expect?</h4>
                        <p>Most customers tell us that Squadhelp’s process is effective, easy, fast, and even fun.
                            We constantly hear <a href="/testimonials-feedback">extremely positive feedback</a> with
                            respect to the breadth of ideas submitted to each contest, and many customers are
                            surprised at how insightful working with dozens of creative individuals from across the
                            globe can be.</p>
                    </li>
                    <li>
                        <h4>What kind of work can I crowdsource?</h4>
                        <p>You can host competitions for Naming, Taglines, Logos, Business cards, Package design,
                            other design projects, and even Product feedback and research.</p>
                    </li>
                    <li className={styles.blackBg}>
                        ...
                        <p>Our creatives work extremely hard to ensure a successful outcome for all projects. If you
                            ...
                            cost. In addition, our Gold and Platinum Packages come with a partial refund option. If
                            you do not like the quality of submissions, you can request a refund for the contest
                            award fees (if you keep your contest award as "Not Guaranteed"). We also offer
                            complimentary branding consultation to ensure you get the best outcome from your
                            contest. Read more about our<a
                    ...
                    <li className={styles.blackBg}>
                        ...
                        <p>Thousands of customers have used Squadhelp to find great Names, Taglines and Logos for
                            their businesses. Here are some of the <a href="/testimonials-feedback">recent customer
                                testimonials</a></p>
                    </li>
                    <li>
                        <h4>Who should use Squadhelp?</h4>
                        <p>Our disruptive approach to naming and branding has been used successfully by just about
                            every type of venture imaginable. Startups and small businesses love our affordable
                            pricing, SM&B gravitate towards our end-to-end service, and large international
                            businesses are particularly excited by the breadth of ideas and the rapid results. We
                            have also worked with nonprofits, municipalities, associations, event planners,
                            agencies, and more.</p>
                    </li>
                    <li className={styles.blackBg}>
                    ...
                    <li>
                        ...
                        <p>Our naming competitions start at $199, and our logo design competitions start at $299.
                            ...
                            benefits. See our <a href="/squadhelp-pricing">Pricing Page</a> for details.</p>
                    </li>
                    <li className={styles.blackBg}>
                        <h4>Do you offer any discount for multiple contests?</h4>
                        <p>Yes! We have many contest bundles - our most popular being our Name, Tagline, and Logo
                            bundle. Bundles allow you to purchase multiple contests at one time and save as much as
                            from $75 - $400. You can learn more about our bundle options on our <a
                    ...
                    <li>
                        ...
                        <p>You can select a Non Disclosure Agreement (NDA) option at the time of launching your
                            ...
                            able to read your project brief and participate in the contest. The contest details will
                            be kept private from other users, as well as search engines.</p>
                    </li>
                    <li className={styles.blackBg}>
                        ...
                        <p>Absolutely. Squadhelp services organizations across the globe. Our customer come from
                            ...
                            We’ve helped more than 25,000 customer around the world.</p>
                    </li>
                </ul>
            </div>
        </div>
